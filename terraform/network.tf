...
# Public Subnet C (ALB 이중화용 - AZ를 c로 변경)
...
resource "aws_lb_listener" "http" { # 인증서 ARN 나오면 리소스 블럭 삭제삭제
...
/*resource "aws_lb_listener" "http" { # 인증서 ARN 나오면 주석 삭제
  load_balancer_arn = aws_lb.main_alb.arn
  port              = "80"
  protocol          = "HTTP"
...
# ============================================================
# 1. 테스트 임시 tls 인증서 생성 실제 도메인 나오면 여기부터 아래까지 삭제해야함
# ============================================================
